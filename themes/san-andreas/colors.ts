// San Andreas theme colors

export const colors = {
    // UI colors
    parchment: "#9BA4B5", // Grayish blue background (like the SA map ocean)
    charcoal: "#1A1A2A", // Very dark navy for text/borders
    water: "#8B94A5", // Slightly darker grayish blue water

    building: "#E0E0E0", // Light gray/white buildings
    ...
    roadOutline: "#0D0D1A", // Even darker road outline
    buildingOutline: "#C8C8C8", // Lighter gray for building outlines
    roadHsl: "#1A1A2A",
