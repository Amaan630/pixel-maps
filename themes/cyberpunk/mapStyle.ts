...
export const mapStyle = {
    ...
    layers: [
        ...
        // 3D Buildings - extruded with cyberpunk styling
        {
            id: "building-3d",
            type: "fill-extrusion",
            source: "openmaptiles",
            ...
            minzoom: 14,
            paint: {
                // Color gradient based on building height - darker red at base, brighter at top
                "fill-extrusion-color": [
                    "interpolate",
                    ["linear"],
                    ["coalesce", ["get", "render_height"], 10],
                    0,
                    colors.building, // Deep red at ground level
                    50,
                    "#8b2525", // Lighter red for medium buildings
                    150,
                    "#ff4444", // Bright red for tall buildings
                    300,
                    "#ff6b6b", // Even brighter for skyscrapers
                ],
                // Height scales in smoothly as you zoom
                ...
                // Base height for buildings with multiple levels
                "fill-extrusion-base": [
                    "interpolate",
                    ["linear"],
                    ["zoom"],
